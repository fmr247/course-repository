...
![](figures/kelly-2024-replication-crisis.png){width=90% fig-align="center"}

- Replication is not just about running the same code — it depends critically on what question you ask and how you measure the answer
- Bayesian reasoning lets you pool evidence across many related tests, which is both more principled and more powerful than applying ad hoc frequentist corrections
