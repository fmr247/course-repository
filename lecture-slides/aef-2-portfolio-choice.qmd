...
- Instead of $\sum_i^N \omega_i=1$, **now** instead assume that all the remaining wealth, $1-\iota'\omega$, is invested in a risk-free asset which pays a constant interest $r_f > 0$
...
ggplot(apple_monthly, aes(x = mkt_excess, y = ret_excess)) +
  ...
  labs(
    title = "CAPM for Apple (AAPL)",
    subtitle = "α shown as intercept, β shown as market sensitivity",
